...
if __name__ == "__main__":
    ...
    train_all = torch.load("./data/basev2-train_features-seq768-title_only-search_ver3.pt")
    dev1_all = torch.load("./data/basev2-dev1_features-seq768-title_only-search_ver3.pt")
    dev2_all = torch.load("./data/basev2-dev2_features-seq768-title_only-search_ver3.pt")        
