...
if __name__ == "__main__":
    ...
    args.local_rank = 0
    path = f"./params-question-only-add-answer{rank}/"
    ...
    train_all = torch.load("../data/basev2-train_features-seq768-question_only-add_answer-search_ver3.pt")
    dev1_all = torch.load("../data/basev2-dev1_features-seq768-question_only-add_answer-search_ver3.pt")
    dev2_all = torch.load("../data/basev2-dev2_features-seq768-question_only-add_answer-search_ver3.pt")        
