...
def get_inputs(mode="train"):
    ...
    ctx1 = pickle.load(open(f"../../search-ver3/data/{mode}_ctx_ids-top10_in-answers.pkl","rb"))
    ctx2 = pickle.load(open(f"../../search-ver3/data/{mode}_ctx_ids-top10_ignore-answers.pkl","rb"))
    ctx3 = pickle.load(open(f"../../search-ver3/data/{mode}_ctx_ids-top10_add-answers.pkl","rb"))
